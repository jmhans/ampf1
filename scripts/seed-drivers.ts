...
// Using official F1 Cloudinary images with extrapolated driver codes
const getDriverImageUrl = (teamFolder: string, driverCode: string) =>
  `https://media.formula1.com/image/upload/c_lfill,w_64/q_auto/d_common:f1:2026:fallback:driver:2026fallbackdriverright.webp/v1740000000/common/f1/2026/${teamFolder}/${driverCode}/2026${teamFolder}${driverCode}right.webp`;
